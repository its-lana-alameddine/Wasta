...
import '../payment/pricing_screen.dart';
...
class descriptionscreen extends StatefulWidget {
  ...
  @override
  _descriptionscreen createState() => _descriptionscreen();
}
                        ...
                        children: [
                          ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  const Color(0xFFAAAAAA).withOpacity(0.56),
                            ...
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      const PricingScreen(), // Replace PricingScreen() with your actual pricing screen widget
                                ),
                              );
                            },
                            child: const Text(
